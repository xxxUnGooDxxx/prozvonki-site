...
(function () {
  ...
  function initCookieNotice() {
    ...
    style.textContent =
      ...
      '.cookie-notice p{flex:1 1 auto;min-width:0;margin:0}.cookie-notice a{color:var(--green-dark,#086b42);font-weight:800;text-decoration:underline;text-underline-offset:3px}' +
